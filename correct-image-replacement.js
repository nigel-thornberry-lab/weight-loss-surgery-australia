...
// Recipe page files
const recipePages = [
  '/Users/Cameron/Desktop/weight-loss-surgery-australia/src/pages/blog/bariatric-surgery-recipes-all-stages.astro',
...
const recipeMappings = {
  ...
  'Berry Blast Smoothie': 'green-smoothie',
  'Creamy Cauliflower Soup': 'mushroom-soup',
  'Tropical Green Smoothie': 'green-smoothie',
  'Sugar-Free Chocolate Pudding': 'protein-hot-chocolate',
  'Mocha Protein Coffee Shake': 'vanilla-protein-shake',
  
  // Stage 3
  'Creamy Chicken Puree': 'chicken-bone-broth',
  'Tuna Salad Puree': 'tuna-salad',
  'Salmon & Sweet Potato Puree': 'salmon-sweet-potato',
  'Refried Bean Puree': 'refried-beans',
  'Cottage Cheese & Fruit Puree': 'cottage-cheese-fruit',
  'Egg Salad Puree': 'egg-salad',
  'Hummus with Greek Yogurt': 'hummus-greek-yogurt',
  'Turkey & Gravy Puree': 'turkey-gravy',
  'Ricotta & Spinach Puree': 'ricotta-spinach',
  'Lentil & Carrot Puree': 'lentil-carrot',
  'White Fish with Pea Puree': 'white-fish-pea',
  'Tofu Scramble Puree': 'tofu-scramble',
  'Avocado & Tuna Puree': 'avocado-tuna',
  ...
  'Turkey Meatballs in Tomato Sauce': 'turkey-meatballs-tomato',
...
function updateRecipePage(filePath, pageName) {
  console.log(`\n🔄 Correctly replacing AI images in ${pageName}...`);
  
  let content = fs.readFileSync(filePath, 'utf8');
  
  const { content: updatedContent, updatedCount } = replaceAIImages(content);
  
  // Write updated content back to file
  fs.writeFileSync(filePath, updatedContent);
  console.log(`✅ ${pageName} complete: ${updatedCount} AI images replaced with real images`);
...
// Main function
function main() {
  console.log('🚀 CORRECTLY replacing AI IMAGE placeholders with real images...\n');
  console.log('This will replace the gradient divs containing "AI IMAGE: [Name]" with actual images');
  console.log('while maintaining the proper HTML structure.\n');
  ...
  console.log(`\n🎉 Image replacement complete! ${totalReplaced} AI images replaced with real images.`);
  console.log('\n📋 What was done:');
  console.log('   - Replaced gradient divs containing "AI IMAGE: [Name]" with actual images');
  console.log('   - Maintained proper HTML structure and formatting');
  console.log('   - Images are properly centered and styled');
  console.log('   - No formatting issues or broken layouts');
}
